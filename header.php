...
<body <?php body_class('presentation-page sidebar-collapse'); ?> data-new-gr-c-s-check-loaded="14.1088.0" data-gr-ext-installed="">
  <?php wp_body_open(); ?>
  <div id="root">
    <header>
          ...
          <div itemscope itemtype="https://schema.org/Service" class="mt-5 container">
            ...
            <div class="ml-auto mr-auto col-md-8">
              <div class="section-description text-center">
                <h1 class="title movingPageHeader-h1"><a href="<?php echo home_url('/'); ?>"><?php the_title(); ?></a></h1>
