...
<section itemscope itemtype="https://schema.org/Service" class="section choice-buttons-bg">
  <div class="container">
    <div class="row">
      <div class="ml-auto mr-auto col-md-8">
        <h2 class="text-center title"><?php echo $title; ?> <br><br><small class="description"><?php echo $tagline; ?></small></h2>
      </div>
    </div>
...
<div class="container-fluid">
  <div class="option-cards row">
    <?php if(have_rows('all_services')):?>
      ...
      ?>
        <div class="col-md-6">
          <div class="option-card option-card{$get_index} card"><img alt="..." src=<?php echo $service_pic; ?> class="option-card-img card-img-top">
            <div class="option-card-body d-flex flex-column card-body">
              ...
              <p class="card-text"><?php echo $service_description; ?></p>
                <a class="btn-round option-button mt-auto btn btn-outline-secondary btn-lg" href="/muuttolaskuri">
...
<div class="container-fluid" style="background-color: rgb(5, 59, 61); padding-top: 5rem; z-index: 9;">
  <div class="row">
    <div class="ml-auto mr-auto col-md-8">
        <h3 class="text-center title mb-0" style="color: rgb(255, 255, 255);"><?php the_field('recommendation_title') ?></h3>
    </div>
  </div>
        ...
        <div class="carousel-inner">
          <?php if(have_rows('recommendations')): ?>
            <?php while(have_rows('recommendations')): the_row();
              $reccomedation_date = get_sub_field('recommendation_date')
            ?>
            <?php endwhile;?>

          <div class="mt-5 carousel-item active">
            <div class="text-center">
              <i class="now-ui-icons ui-2_like mt-5 text-center rating-icons"></i>
              <i class="now-ui-icons ui-2_like mt-5 text-center rating-icons"></i>
              <i class="now-ui-icons ui-2_like mt-5 text-center rating-icons"></i>
              <i class="now-ui-icons ui-2_like mt-5 text-center rating-icons"></i>
              <i class="now-ui-icons ui-2_like mt-5 text-center rating-icons"></i>
            ...
            <p class="mt-5 text-center rating-paragraph" style="color: rgb(255, 255, 255);">"Hyvin
              ...
              kympin suoritus. Suosittelen!"</p>
              <img src="data:image/png;base64," alt="FirstRating" class="d-block">
            <div class="carousel-caption d-md-block mt--6">
                <h5>- Muuttaja Turku - Tampere</h5>
                        ...
                        <a class="carousel-control-prev" data-slide="prev" href=" " role="button"><i
